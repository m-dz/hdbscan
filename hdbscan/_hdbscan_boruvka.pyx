...
cdef class BoruvkaAlgorithm (object):
    """Parent class for KDTree and BallTree implementations"""
    ...
    def __init__(self, tree, sample_weights=None, min_samples=5,
        ...
        print('BoruvkaAlgorithm __init__')
...
cdef class KDTreeBoruvkaAlgorithm (BoruvkaAlgorithm):
    ...
    #     print('KDTree __init__')
    #     super(KDTreeBoruvkaAlgorithm, self).__init__(
    #         tree=tree, sample_weights=sample_weights, min_samples=min_samples,
    #         metric=metric, leaf_size=leaf_size, alpha=alpha,
    #         approx_min_span_tree=approx_min_span_tree, n_jobs=n_jobs, **kwargs)
...
cdef class BallTreeBoruvkaAlgorithm (BoruvkaAlgorithm):

    # def __init__(self, tree, sample_weights=None, min_samples=5,
    #              metric='euclidean', leaf_size=20, alpha=1.0,
    #              approx_min_span_tree=False, n_jobs=4, **kwargs):

    #     print('BallTree __init__')
    #     super(BallTreeBoruvkaAlgorithm, self).__init__(
    #         tree=tree, sample_weights=sample_weights, min_samples=min_samples,
    #         metric=metric, leaf_size=leaf_size, alpha=alpha,
    #         approx_min_span_tree=approx_min_span_tree, n_jobs=n_jobs, **kwargs)
    ...
    def _create_tree(self, tree_data, metric, leaf_size, **kwargs):
        ...
        print('def BallTree _create_tree')
        return BallTree(tree_data, metric=metric, leaf_size=leaf_size, **kwargs)
